...
if ($error = create_config("test_mysqlnd_ms_slave_unreachable_random_once.ini", $settings))
	die(sprintf("SKIP %s\n", $error));
?>
--INI--
error_reporting=E_ALL
mysqlnd_ms.enable=1
mysqlnd_ms.ini_file=test_mysqlnd_ms_slave_unreachable_random_once.ini
