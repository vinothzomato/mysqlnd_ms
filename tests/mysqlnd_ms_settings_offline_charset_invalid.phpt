--TEST--
Invalid offline_server_charset
--SKIPIF--
<?php
...
--INI--
mysqlnd_ms.enable=1
mysqlnd_ms.ini_file=test_mysqlnd_ms_settings_offline_charset_invalid.ini
--FILE--
<?php
	require_once("connect.inc");
...
?>
--EXPECTF--
Fatal error: mysqli_real_connect(): (mysqlnd_ms) Erroneous offline_server_charset [please_let_me_be_invalid] in %s on line %d