...
--INI--
mysqlnd_ms.enable=1
mysqlnd_ms.config_file=test_mysqlnd_ms_table_parser18.ini
--FILE--
<?php
	require_once("connect.inc");
...
<?php
	if (!unlink("test_mysqlnd_ms_table_parser18.ini"))
		printf("[clean] Cannot unlink ini file 'test_mysqlnd_ms_table_parser18.ini'.\n");
?>
--EXPECTF--
[001] Testing server support of 'SELECT _latin1'string' AS _id'
[006] _id = 'string'
[009] Testing server support of 'SELECT _latin1'string' COLLATE latin1_danish_ci AS _id'
[012] _id = 'string'
done!