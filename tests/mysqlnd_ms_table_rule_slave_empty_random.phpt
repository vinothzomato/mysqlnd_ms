...
if ($error = create_config("test_mysqlnd_ms_table_rule_slave_empty_random.ini", $settings))
	die(sprintf("SKIP %s\n", $error));
?>
--INI--
mysqlnd_ms.enable=1
mysqlnd_ms.ini_file=test_mysqlnd_ms_table_rule_slave_empty_random.ini
--FILE--
<?php
	require_once("connect.inc");
