...
if ($error = mst_create_config("test_mysqlnd_ms_force_charset_real_escape.ini", $settings))
	die(sprintf("SKIP %s\n", $error));

?>
--INI--
mysqlnd_ms.enable=1
mysqlnd_ms.config_file=test_mysqlnd_ms_force_charset_real_escape.ini
--FILE--
<?php
	require_once("connect.inc");
...
--CLEAN--
<?php
if (!unlink("test_mysqlnd_ms_force_charset_real_escape.ini"))
	printf("[clean] Cannot unlink ini file 'test_mysqlnd_ms_force_charset_real_escape.ini'.\n");
?>
--EXPECTF--
done!