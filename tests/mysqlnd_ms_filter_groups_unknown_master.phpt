...
--CLEAN--
<?php
	if (!unlink("test_mysqlnd_ms_filter_groups_unknown_master.ii"))
...
[001] [2000] (mysqlnd_ms) Unknown master 'master2' (section 'A') in 'node_groups' filter configuration. Stopping
array(1) {
  ["_role"]=>
  string(7) "master1"
}
