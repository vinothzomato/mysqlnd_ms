...
--INI--
mysqlnd_ms.enable=1
mysqlnd_ms.ini_file=test_mysqlnd_ms_settings_host_credentials_invalid.ini
--FILE--
<?php
	require_once("connect.inc");
...
?>
--EXPECTF--
Catchable fatal error: mysqli_real_connect(): (mysqlnd_ms) Invalid value for port '%s' . Stopping in %s on line %d
