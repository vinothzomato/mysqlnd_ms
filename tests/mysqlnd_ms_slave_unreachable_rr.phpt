--TEST--
Unreachable slave, pick = rr, lazy = 0
--SKIPIF--
<?php
...
if ($error = create_config("test_mysqlnd_ms_slave_unreachable_rr.ini", $settings))
	die(sprintf("SKIP %s\n", $error));
?>
--INI--
error_reporting=E_ALL
mysqlnd_ms.enable=1
mysqlnd_ms.ini_file=test_mysqlnd_ms_slave_unreachable_rr.ini
