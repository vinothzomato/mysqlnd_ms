--TEST--
mysqlnd_ms_set_qos(), trx stickiness
--SKIPIF--
<?php
...
if ($error = mst_create_config("test_mysqlnd_ms_set_qos_trx_stickiness_on.ini", $settings))
	die(sprintf("SKIP %s\n", $error));
...
--INI--
mysqlnd_ms.enable=1
mysqlnd_ms.config_file=test_mysqlnd_ms_set_qos_trx_stickiness_on.ini
...
--CLEAN--
<?php
	if (!unlink("test_mysqlnd_ms_set_qos_trx_stickiness_on.ini"))
	  printf("[clean] Cannot unlink ini file 'test_mysqlnd_ms_set_qos_trx_stickiness_on.ini'.\n");
?>
--EXPECTF--
