...
?>
--EXPECTF--
Warning: mysqli::query(): (mysqlnd_ms) Couldn't find the appropriate slave connection. 0 slaves to choose from. Something is wrong in /home/nixnutz/php/php-src/pecl/mysqlnd_ms/trunk/tests/util.inc on line 105

Warning: mysqli::query(): (mysqlnd_ms) No connection selected by the last filter in /home/nixnutz/php/php-src/pecl/mysqlnd_ms/trunk/tests/util.inc on line 105
