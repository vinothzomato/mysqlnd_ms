...
if ($error = create_config("test_mysqlnd_ms_settings_lazy_failover_master_random.ini", $settings))
	die(sprintf("SKIP %d\n", $error));
?>
--INI--
mysqlnd_ms.enable=1
mysqlnd_ms.ini_file=test_mysqlnd_ms_settings_lazy_failover_master_random.ini
...
--CLEAN--
<?php
	if (!unlink("test_mysqlnd_ms_settings_lazy_failover_master_random.ini"))
	  printf("[clean] Cannot unlink ini file 'test_mysqlnd_ms_settings_lazy_failover_master_random.ini'.\n");
?>
--EXPECTF--
