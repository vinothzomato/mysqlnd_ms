--TEST--
Fabric: config parsing (string used for hosts list)
--SKIPIF--
<?php
...
if ($error = mst_create_config("test_mysqlnd_ms_fabric_config5.ini", $settings))
  die(sprintf("SKIP %s\n", $error));
?>
--INI--
mysqlnd_ms.enable=1
mysqlnd_ms.config_file=test_mysqlnd_ms_fabric_config5.ini
--FILE--
<?php
	require_once("connect.inc");
...
--CLEAN--
<?php
	if (!unlink("test_mysqlnd_ms_fabric_config5.ini"))
