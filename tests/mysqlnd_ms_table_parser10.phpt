...
<?php
	...
	$sql = "SELECT SQL_SMALL_RESULT id AS _id FROM test ORDER BY id ASC";
...
?>
--EXPECTF--
[001] Testing server support of 'SELECT SQL_SMALL_RESULT id AS _id FROM test ORDER BY id ASC'
[003 + 01] Query 'SELECT SQL_SMALL_RESULT id AS _id FROM test ORDER BY id ASC'
[003 + 02] Thread '%d'
[004] _id = '%d'
done!