--TEST--
multi query (set server option) wo ms
--SKIPIF--
<?php
...
--INI--
mysqlnd_ms.enable=1
mysqlnd_ms.ini_file=test_mysqlnd_ms_multi_query_no_ms.ini
--FILE--
<?php
	require_once("connect.inc");
...
--CLEAN--
<?php
	if (!unlink("test_mysqlnd_ms_multi_query_no_ms.ini"))
	  printf("[clean] Cannot unlink ini file 'test_mysqlnd_ms_multi_query_no_ms.ini'.\n");
?>
--EXPECTF--
