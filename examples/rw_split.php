...
if (!($conn = new mysqli("examples_section", DB_USER, DB_PASSWORD, DB_SCHEMA)) || mysqli_connect_errno()) {
	die(sprintf("Please check the mysqlnd_ms_config.ini and config.php, failed to connect: [%d] %s\n",
